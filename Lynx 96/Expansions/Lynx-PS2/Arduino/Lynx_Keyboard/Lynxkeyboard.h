...
#ifndef Lynxkeyboard_h
#define Lynxkeyboard_h
...
#include "WProgram.h"
#endif
#define Lynx_KEYMAP_SIZE 	   152 // Size of each array in the key maps

#include "keymapping.h"

#define debug   false    // Set true for serial monitor of Lynx keycodes and PS/2 keycodes
...
class Lynxkeyboard {
  public:
    ...
    static void begin(const LynxKeymap_t &map = LynxKeymap_main);
};
#endif
